...
void mainGame::maingameimg()
{
	...
	IMAGEMANAGER->addImage("Ä§´ë", "images/¸ÊÅø/³»¹æ/housebed.bmp", 32, 49, true, RGB(255, 0, 255));
	IMAGEMANAGER->addImage("Ä§´ë2", "images/¸ÊÅø/³»¹æ/Ä§´ë2.bmp", 32, 33, true, RGB(255, 0, 255));
	...
	IMAGEMANAGER->addImage("µ¹", "images/item/³ª¹«.bmp", 16 * 3, 16 * 3, true, RGB(255, 0, 255));
	IMAGEMANAGER->addImage("ÀâÃÊ", "images/item/ÀâÃÊ.bmp", 16 * 3, 15 * 3, true, RGB(255, 0, 255));
	IMAGEMANAGER->addImage("·çºñ", "images/item/·çºñ.bmp", 11 * 3, 16 * 3, true, RGB(255, 0, 255));
	...
	IMAGEMANAGER->addImage("³ª¹«2", "images/etc/³ª¹«2.bmp", 50, 100, true, RGB(255, 0, 255));
}
