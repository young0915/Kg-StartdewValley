...
void maptool::controlMaptoolBoard()
{
	...
	if (_sampleboard._isopen)
	{
		...
		_sampleboard._button[0].rc = RectMakeCenter(_sampleboard._button[0].x, _sampleboard._button[0].y,
		_sampleboard._button[0]._btnimg->getFrameX(), _sampleboard._button[0]._btnimg->getHeight());

		_sampleboard._button[1]._btnimg = IMAGEMANAGER->findImage("맵툴오른쪽");
		_sampleboard._button[1].x = WINSIZEX / 2 + 150;
		_sampleboard._button[1].y = WINSIZEY / 2 + 70;
		_sampleboard._button[1].rc = RectMakeCenter(_sampleboard._button[1].x, _sampleboard._button[1].y, _sampleboard._button[1]._btnimg->getWidth(), _sampleboard._button[1]._btnimg->getHeight());

		_sampleboard._button[2]._btnimg = IMAGEMANAGER->findImage("맵툴왼쪽");
		_sampleboard._button[2].x = WINSIZEX / 2 + 350;
		_sampleboard._button[2].y = WINSIZEY / 2 + 70;
		_sampleboard._button[2].rc = RectMakeCenter(_sampleboard._button[2].x, _sampleboard._button[2].y, _sampleboard._button[2]._btnimg->getWidth(), _sampleboard._button[2]._btnimg->getHeight());

		_sampleboard._button[3]._btnimg = IMAGEMANAGER->findImage("지우기");
		_sampleboard._button[3].x = WINSIZEX / 2 + 340;
		_sampleboard._button[3].y = 500;
		_sampleboard._button[3].rc = RectMakeCenter(_sampleboard._button[3].x, _sampleboard._button[3].y, _sampleboard._button[3]._btnimg->getWidth(), _sampleboard._button[3]._btnimg->getHeight());

		_sampleboard._button[4]._btnimg = IMAGEMANAGER->findImage("타일");
		_sampleboard._button[4].x = WINSIZEX / 2+120;
		_sampleboard._button[4].y = 500;
		_sampleboard._button[4].rc = RectMakeCenter(_sampleboard._button[4].x, _sampleboard._button[4].y, _sampleboard._button[4]._btnimg->getWidth(), _sampleboard._button[4]._btnimg->getHeight());
		...
		_sampleboard._button[5].rc = RectMakeCenter(_sampleboard._button[5].x, _sampleboard._button[5].y, _sampleboard._button[5]._btnimg->getWidth(), _sampleboard._button[5]._btnimg->getHeight());
		...
		_sampleboard._button[6].rc = RectMakeCenter(_sampleboard._button[6].x, _sampleboard._button[6].y, _sampleboard._button[6]._btnimg->getWidth(), _sampleboard._button[6]._btnimg->getHeight());
		...
		_sampleboard._button[7].rc = RectMakeCenter(_sampleboard._button[7].x, _sampleboard._button[7].y, _sampleboard._button[7]._btnimg->getWidth(), _sampleboard._button[7]._btnimg->getHeight());
	}
}
